        ...
        <div class="py-8 px-4 max-w-6xl mx-auto space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-5 gap-3">
                    ...
                    <a :href="route('admin.evaluation-windows')" class="rounded-xl border border-gray-200 bg-white p-4 flex items-center gap-3 hover:bg-gray-50 transition">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-gray-800">Evaluation Window</p>
                            <p class="text-xs text-gray-400">Create new</p>
                        </div>
                    </a>
