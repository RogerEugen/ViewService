<script setup>
import { HomeIcon, InboxIcon, ChartBarIcon, ChatBubbleLeftRightIcon, RectangleGroupIcon } from '@heroicons/vue/24/outline';
import { ref } from 'vue';
            ...
            >
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink :href="route('hod.recurring-issues')" :active="route().current('hod.recurring-issues')">
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('hod.recurring-issues')" :active="route().current('hod.recurring-issues')">
